...
RSpec.describe "merchant dashboard" do
  before :each do
    ...
    @discount2 = @merchant2.bulk_discounts.create!(percentage_discount: 30, quantity_threshold: 15)
    ...
    @ii_8 = InvoiceItem.create!(invoice_id: @invoice_7.id, item_id: @item_5.id, quantity: 1, unit_price: 5, status: 1)

    @ii_1.update!(bulk_discount_id: @discount1.id)
    @ii_8.update!(bulk_discount_id: @discount1.id)
  ...
  it "shows a link to view all of my discounts" do
    ...
    expect(current_path).to eq(merchant_bulk_discounts_path(@merchant1))
      ...
      expect(current_path).to eq(merchant_bulk_discount_path(@merchant2, @discount2))
